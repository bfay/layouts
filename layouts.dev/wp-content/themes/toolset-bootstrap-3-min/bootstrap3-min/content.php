...
<article <?php post_class( 'clearfix' ) ?> id="post-<?php the_ID(); ?>">
	...
	<?php else : ?>
		...
		<a href="<?php the_permalink(); ?>" class="post-thumbnail img-thumbnail pull-left">
		...
		<?php
		if ( is_single() ) :
			edit_post_link( __( 'Edit post', 'wpbootstrap' ), '<p class="btn btn-sm btn-default">', '</p>' );
		endif;
		?>
		...
		<?php wpbootstrap_link_pages(); ?>
			...
			<a class="btn btn-primary btn-lg" href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to', 'wpbootstrap' ) . ' %s', the_title_attribute( 'echo=0' ) ) ); ?>">
